...
const Patners = () => {
  return (
    <div className='row' id="ony" >
      <div id="title1">
          <h2 ><strong>OUR PATNERS</strong></h2><br/>
          
      </div>
      <div id="title2">
        <p>    At Ooko Estates, we value strong partnerships that enhance our ability to deliver exceptional service. Collaborating with industry leaders and trusted affiliates allows us to innovate and provide tailored solutions that meet our clients' diverse needs.</p>
      </div>
          
          <div className='row' >
              <Col className='col-3'>
                  ubuntu
                      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="white" class="bi bi-ubuntu" viewBox="0 0 16 16">
              ...
              <Col className='col-3'>
                  Amazon
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#FF9900" class="bi bi-amazon" viewBox="0 0 16 16">
              ...
              <Col className='col-3'>
                  nvidia
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="blue" class="bi bi-nvidia" viewBox="0 0 16 16">
